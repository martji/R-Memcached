...
public class MainTest
{
	...
	{
		PropertyConfigurator.configure(MainTest.class.getClass().getResource("/").getPath()+"log4j.properties");//¼ÓÔØ.propertiesÎÄ¼þ 
		//String[] serverlist = { "127.0.0.1:20000", "127.0.0.1:20001" , "127.0.0.1:20002" };
	...
	private static class bench extends Thread 
	{
		...
		public void run() 
		{
			...
			result.append("\nthread " + threadNum + ": runs: " + runs + " read or write of obj " + (size/1024) + "KB -- avg time per req " + avg + " ms (total: " + elapse + " ms)");
