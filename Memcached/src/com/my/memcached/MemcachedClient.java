...
public class MemcachedClient {
	...
	public MemcachedClient( String HostName ) {
		...
		try
		{
			...
			if ( !sock.isConnected() ) {
				log.error( "++++ failed to get SockIO obj for: " + HostName + " -- new socket is not connected" );
				sock = null;
			}
	 ...
	 */
	public MemcachedClient( ClassLoader classLoader, ErrorHandler errorHandler, String HostName ) {
		this.classLoader  = classLoader;
		this.errorHandler = errorHandler;
		this.HostName     = HostName;
		init();
