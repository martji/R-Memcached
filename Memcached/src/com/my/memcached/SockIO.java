...
public class SockIO implements LineInputStream
{
	 ...
	 */
	public SockIO(String host, int port, int timeout, int connectTimeout, boolean noDelay ) throws IOException, UnknownHostException {
	 ...
	 * @throws UnknownHostException if hostname is invalid
	 */
	public SockIO(String host, int timeout, int connectTimeout, boolean noDelay ) throws IOException, UnknownHostException {
